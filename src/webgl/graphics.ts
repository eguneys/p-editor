...
export class Graphics {
  ...
  glOnce = (options: GlOnceOptions = {}) => {
    ...
    let [r,g,b] = color_rgb(color||0x000000)
  ...
  glUseTexture(glTexture: any, texture: any, n: number) {
    let { gl } = this
  ...
  glUse(program: any, uniformData: any) {
    let { gl } = this
  ...
  glUniformUpdate(uniformData: any, u_blend: any) {
    let { gl } = this
  ...
  glAttribUpdate(buffer: any, srcData: any) {
  ...
  glIndexUpdate(buffer: any, srcData: any) {
